...
const uint8_t DIVEC_MS5837::MS5837_30BA = 0;
const uint8_t DIVEC_MS5837::MS5837_02BA = 1;

bool DIVEC_MS5837::init() {
...
void DIVEC_MS5837::setModel(uint8_t model) {
	_model = model;
}

void DIVEC_MS5837::read() {
...
uint32_t DIVEC_MS5837::pressure() {
	return P;
}

int32_t DIVEC_MS5837::temperature() {
	return TEMP;
}

uint8_t DIVEC_MS5837::crc4(uint16_t n_prom[]) {
	uint16_t n_rem = 0;
